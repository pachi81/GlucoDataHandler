...
class ChartBitmapView(val imageView: ImageView, val context: Context, durationPref: String = "", showAxisPref: String? = null): NotifierInterface {
    ...
    init {
        ...
        chartBitmap = ChartBitmap(context, durationPref, showAxisPref = showAxisPref)
