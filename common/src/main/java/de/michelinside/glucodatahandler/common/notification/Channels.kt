...
enum class ChannelType(val channelId: String, val nameResId: Int, val descrResId: Int, val importance: Int = NotificationManager.IMPORTANCE_DEFAULT) {
    ...
    MOBILE_THIRD("GlucoDataNotify_third", R.string.mobile_third_notification_name, R.string.mobile_second_notification_descr ),
    ...
    ALARM("gdh_alarm_notification_channel_68", R.string.alarm_notification_name, R.string.alarm_notification_descr, NotificationManager.IMPORTANCE_MAX );
}
object Channels {
