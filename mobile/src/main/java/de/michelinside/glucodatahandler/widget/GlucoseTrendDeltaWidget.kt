 ...
 */
class GlucoseTrendDeltaWidget : AppWidgetProvider(), NotifierInterface {
        ...
        fun create(context: Context) {
            ...
            if (!init) {
                val component = ComponentName(
                    context,
                    GlucoseTrendDeltaWidget::class.java
                )
                with(AppWidgetManager.getInstance(context)) {
                    ...
                    if (appWidgetIds.isNotEmpty()) {
                        ...
                        val intent = Intent(context, GlucoseTrendDeltaWidget::class.java)
