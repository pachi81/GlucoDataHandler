...
/**
 * Requests a refresh of the [GlucoseValueTileService] whenever new data arrives.
 *
 * Registered as a notifier in [de.michelinside.glucodatahandler.GlucoDataServiceWear], mirroring
 * [GlucoseGraphTileUpdater]. requestUpdate on a tile that is not currently added to the carousel is a
    ...
    override fun OnNotifyData(context: Context, dataSource: NotifySource, extras: Bundle?) {
        try {
            ...
            TileService.getUpdater(context)
                .requestUpdate(GlucoseValueTileService::class.java)
        } catch (exc: Exception) {
